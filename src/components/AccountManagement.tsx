                                    ...
                                    <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex flex-col justify-end p-4">
                                       ...
                                       >
                                          ...
                                          <form onSubmit={handleAddExerciseSubmit} className="space-y-4 text-left">
                                             ...
                                             <div>
                                                <label className="text-[10px] font-black uppercase text-slate-900 block mb-1">URL da Imagem (Opcional)</label>
                                                <input 
                                                  type="url" 
                                                  value={newExImage} 
                                             ...
                                             <div>
                                                <label className="text-[10px] font-black uppercase text-slate-900 block mb-1">URL do Vídeo Demonstrativo (Opcional)</label>
                                                <input 
                                                  type="url" 
                                                  value={newExVideo} 
